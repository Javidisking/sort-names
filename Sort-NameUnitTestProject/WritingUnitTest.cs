...
namespace ContactAppUnitTestProject
{
    ...
    public class WritingUnitTest
    {
        ...
        [TestMethod]
        public void ProvideContactList_WriteToFile_TotalContactSavedToFileMatch()
        {
            #region Create Sample Contact List
        ...
        public void ProvideContactList_WriteToFile_AllContactSavedToFileMatchOriginalList()
        {
            #region Create Sample Contact List
